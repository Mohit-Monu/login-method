  ...
  return (
    <Card className={classes.login}>
      <form onSubmit={submitHandler}>
        ...
        <Input id="password" label="Please Enter Password" type="password" isValid={passwordIsValid} value={passwordState.value} onChange={passwordChangeHandler} onBlur={validatePasswordHandler} ></Input>
